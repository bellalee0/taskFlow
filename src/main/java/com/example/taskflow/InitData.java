...
public class InitData {
    ...
    public void init() {
        // --- Users ---
        User user1 = new User("alpha", "alpha@test.com", /*passwordEncoder.encode("1234")*/"1234", "알파");
        User user2 = new User("beta", "beta@test.com", /*passwordEncoder.encode("1234")*/"1234", "베타");

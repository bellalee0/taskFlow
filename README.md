...
**TaskFlow**는 기업용 태스크 관리를 위한 REST API 기반 백엔드 서버입니다.

프론트엔드 개발이 완료된 상태에서 **일주일**이라는 짧은 기간 동안 안정적인 백엔드 서버를 구축하는 **아웃소싱 프로젝트**로 진행되었습니다.
...
- **2025년 12월 08일(월) ~ 2025년 12월 15일(월)** (총 6일)
